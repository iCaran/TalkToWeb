...
class bardSesh():
    ...
    def ai_summary(self, text_to_summarize):
        # Call the API to generate the summary
        prompt = "Please summarize this article, but try to maintain every detail as much as possible, and try to make the summary as long as possible: \n\n"
